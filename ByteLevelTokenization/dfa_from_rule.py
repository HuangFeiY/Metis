...
from automata_tools import BuildAutomata, Automata, DFAtoMinimizedDFA, NFAtoDFA, isInstalled, drawGraph, WFA, \
    get_word_to_index
...
class NFAFromRegex:
    ...
    def buildNFA(self, rule: str, reversed: bool = False, ruletokens=None) -> Automata:
        language = set()
        self.stack = []
        self.automata = []
